            ...
            <div className="relative hidden md:block">
              ...
              <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-white p-10 text-center">
                ...
                <p className="text-sm opacity-90 max-w-xs">
                  Simplify event entry with smart check-in, real-time attendee scanning, and instant badge printing.
                  Designed for conferences, exhibitions, and corporate events.
                </p>
